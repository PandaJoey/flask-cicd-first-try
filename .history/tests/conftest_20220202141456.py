...
#opens and reads the data in data.sql
...
some internal behavior so it’s easier to test, and other extensions 
...
test_hello function you’ll write next takes a client argument. 
